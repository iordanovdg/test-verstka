(() => {
    ...
    function initSliders() {
        if (document.querySelector(".hero-slider")) {
            let thumbSlider = new core(`.small-slider`, {
    ...
    window.addEventListener("load", (() => {
        ...
        overlayBtn.addEventListener("click", anim);
    }));
    function anim() {
        ...
        document.querySelector(".overlay-wrapper").classList.add("hidden");
    }
    function changeSubTitle() {
        let slideContents = document.querySelectorAll(".hero-slide__content");
        if (slideContents.length > 0) slideContents.forEach((slide => {
